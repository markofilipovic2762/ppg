export const AG_GRID_LOCALE_SR = {
  // Set Filter
  ...
  advancedFilterValidationMessage:
    "Izraz ima grešku. ${variable} - ${variable}.",
  advancedFilterValidationMessageAtEnd:
    "Izraz ima grešku. ${variable} na kraju izraza.",
  ...
  advancedFilterBuilderMoveDownButtonTooltip: "Pomakni dole",
  advancedFilterBuilderAddJoin: "Dodaj grupu",
  advancedFilterBuilderAddCondition: "Dodaj filter",
  advancedFilterBuilderSelectColumn: "Odaberi kolonu",
  advancedFilterBuilderSelectOption: "Odaberi opciju",
  advancedFilterBuilderEnterValue: "Unesi vrednost...",
  advancedFilterBuilderValidationAlreadyApplied:
    "Trenutni filter je već primenjen.",
  advancedFilterBuilderValidationIncomplete: "Nisu svi uslovi ispunjeni.",
  advancedFilterBuilderValidationSelectColumn: "Moraš odabrati kolonu.",
  advancedFilterBuilderValidationSelectOption: "Moraš odabrati opciju.",
  advancedFilterBuilderValidationEnterValue: "Moraš uneti vrednost.",
  ...
  groups: "Grupisanje redova",
  rowGroupColumnsEmptyMessage:
    "Povucite ovde za postavljanje grupisanjaa redova",
  values: "Vrednosti",
  valueColumnsEmptyMessage: "Povucite ovde za izvođenje agregacije",
  pivots: "Oznake kolona",
  pivotColumnsEmptyMessage: "Povucite ovde za postavljanje oznaka kolona",
  ...
  // Menu
  pinColumn: "Prikaci kolonu",
  pinLeft: "Privači levo",
  pinRight: "Prikači desno",
  noPin: "Bez prikačivanja",
  ...
  ariaAdvancedFilterBuilderItem:
    "${variable}. Razina ${variable}. Pritisnite ENTER za uređivanje.",
  ...
  ariaRowSelectAll:
    "Pritisnite SPACE za uključivanje/isključivanje odabira svih redaka",
  ariaRowToggleSelection:
    "Pritisnite SPACE za uključivanje/isključivanje odabira retka",
  ...
  ariaToggleVisibility:
    "Pritisnite SPACE za uključivanje/isključivanje vidljivosti",
  ariaToggleCellValue:
    "Pritisnite SPACE za uključivanje/isključivanje vrijednosti ćelije",
  ...
  ariaDropZoneColumnValueItemDescription:
    "Pritisnite ENTER za promjenu tipa agregacije",
  ...
  ariaLabelRichSelectToggleSelection:
    "Pritisnite RAZMAKNICU za prebacivanje odabira",
  ariaLabelRichSelectDeselectAllItems:
    "Pritisnite DELETE za poništavanje odabira svih stavki",
  ariaLabelRichSelectDeleteSelection:
    "Pritisnite DELETE za poništavanje odabira stavke",
  ...
  ariaLabelAdvancedFilterAutocomplete:
    "Napredna funkcija automatskog dovršavanja filtera",
  ariaLabelAdvancedFilterBuilderAddField:
    "Napredni graditelj filtera - dodajte polje",
  ariaLabelAdvancedFilterBuilderColumnSelectField:
    "Napredni graditelj filtera - odaberite polje stupca",
  ariaLabelAdvancedFilterBuilderOptionSelectField:
    "Napredni graditelj filtera - odaberite polje opcije",
  ariaLabelAdvancedFilterBuilderJoinSelectField:
    "Napredni graditelj filtera - odaberite polje operatera za spajanje",
