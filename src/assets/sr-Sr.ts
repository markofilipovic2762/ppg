export const AG_GRID_LOCALE_SR = {
  ...
  advancedFilterValidationMissingQuote:
    "Vrijednosti nedostaje završna navodna oznaka",
  ...
  advancedFilterValidationJoinOperatorMismatch:
    "Spojni operatori unutar uvjeta moraju biti isti",
  ...
  advancedFilterBuilderValidationAlreadyApplied:
    "Trenutni filter je već primijenjen.",
  ...
  rowGroupColumnsEmptyMessage:
    "Povucite ovdje za postavljanje grupiranja redaka",
  values: "Vrijednosti",
