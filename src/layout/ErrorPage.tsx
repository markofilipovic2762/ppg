          ...
          <div className="row">
            <div className="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
              <div className="relative ">
                ...
                <span className="absolute  top-0   -ml-12  text-gray-300 text-xl font-semibold">
                  Uuups!
                </span>
              </div>
              <h5 className="text-gray-300 font-semibold -mr-10 -mt-3 text-xl">
                Stranica ne postoji
              </h5>
              <p className="text-gray-100 text-2xl mt-2 mb-6">
